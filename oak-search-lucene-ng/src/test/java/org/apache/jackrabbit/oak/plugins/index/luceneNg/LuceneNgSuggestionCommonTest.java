...
/**
 * Runs {@link IndexSuggestionCommonTest} against Lucene 9 ({@code lucene9}) indexes
 * so suggestion behaviour matches legacy Lucene.
 */
public class LuceneNgSuggestionCommonTest extends IndexSuggestionCommonTest {
