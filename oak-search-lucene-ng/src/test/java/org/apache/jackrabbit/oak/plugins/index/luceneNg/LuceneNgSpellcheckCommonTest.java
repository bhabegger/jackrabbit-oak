...
/**
 * Runs {@link SpellcheckCommonTest} against Lucene 9 ({@code lucene9}) indexes
 * so spellcheck behaviour matches legacy Lucene.
 */
public class LuceneNgSpellcheckCommonTest extends SpellcheckCommonTest {
