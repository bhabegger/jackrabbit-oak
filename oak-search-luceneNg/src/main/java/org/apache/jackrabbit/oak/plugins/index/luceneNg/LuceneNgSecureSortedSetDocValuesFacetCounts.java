 ...
 */
class LuceneNgSecureSortedSetDocValuesFacetCounts extends SortedSetDocValuesFacetCounts {
    ...
    LuceneNgSecureSortedSetDocValuesFacetCounts(DefaultSortedSetDocValuesReaderState state,
