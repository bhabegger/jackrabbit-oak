 ...
 */
class LuceneNgStatisticalSortedSetDocValuesFacetCounts extends SortedSetDocValuesFacetCounts {
    ...
    LuceneNgStatisticalSortedSetDocValuesFacetCounts(DefaultSortedSetDocValuesReaderState state,
    ...
    private Iterator<Integer> getMatchingDocIterator(final List<FacetsCollector.MatchingDocs> matchingDocsList) {
        Iterator<FacetsCollector.MatchingDocs> matchingDocsListIterator = matchingDocsList.iterator();
    ...
    private Iterator<Integer> getSampledMatchingDocIterator(Iterator<Integer> matchingDocs,
                                                            ...
                                                            int hitCount,
                                                            int sampleSize) {
        TapeSampling<Integer> tapeSampling =
