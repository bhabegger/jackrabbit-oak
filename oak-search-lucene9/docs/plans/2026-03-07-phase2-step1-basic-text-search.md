...
**Files:**
- Create: `src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IndexSearcherHolder.java`
- Test: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IndexSearcherHolderTest.java`
...
import org.apache.jackrabbit.oak.plugins.index.lucene9.directory.BlobFactory;
import org.apache.jackrabbit.oak.plugins.index.lucene9.directory.OakDirectory;
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=IndexSearcherHolderTest`
...
```bash
cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9
git add src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IndexSearcherHolder.java \
        src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IndexSearcherHolderTest.java
...
## Task 2: Lucene9QueryIndexProvider (Provider)

**Files:**
- Create: `src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9QueryIndexProvider.java`
- Test: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9QueryIndexProviderTest.java`
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=Lucene9QueryIndexProviderTest`
Expected: FAIL with "cannot find symbol: class Lucene9QueryIndexProvider"

**Step 3: Write minimal Lucene9QueryIndexProvider implementation**
 ...
 * Returns Lucene9Index instances for all Lucene 9 indexes in the repository.
 */
public class Lucene9QueryIndexProvider implements QueryIndexProvider {

    private final Lucene9IndexTracker tracker;

    public Lucene9QueryIndexProvider(Lucene9IndexTracker tracker) {
    ...
    public List<? extends QueryIndex> getQueryIndexes(NodeState nodeState) {
        ...
        List<Lucene9Index> indexes = new ArrayList<>();

        // Get all tracked Lucene 9 indexes
        for (String indexPath : tracker.getIndexPaths()) {
            Lucene9IndexNode indexNode = tracker.acquireIndexNode(indexPath);
            if (indexNode != null) {
                indexes.add(new Lucene9Index(tracker, indexPath));
            }
        }
...
**Step 4: Add getIndexPaths() method to Lucene9IndexTracker**

Modify: `src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9IndexTracker.java`
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=Lucene9QueryIndexProviderTest`
Expected: FAIL (Lucene9Index doesn't exist yet, but provider compiles)

**Step 6: Commit provider (even though tests don't pass yet)**

```bash
cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9
git add src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9QueryIndexProvider.java \
        src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9IndexTracker.java \
        src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9QueryIndexProviderTest.java
git commit -m "feat: add Lucene9QueryIndexProvider

- Implements QueryIndexProvider interface
- Returns Lucene9Index for each tracked index
- Integrates with Lucene9IndexTracker
- Tests will pass once Lucene9Index is implemented
...
## Task 3: Lucene9Index (Basic Query Execution)

**Files:**
- Create: `src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9Index.java`
- Test: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9IndexTest.java`
...
public class Lucene9IndexTest {
    ...
    public void testBasicTextQuery() throws Exception {
        ...
        Lucene9Index index = new Lucene9Index(tracker, "/oak:index/test");
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=Lucene9IndexTest`
Expected: FAIL with "cannot find symbol: class Lucene9Index"

**Step 3: Write minimal Lucene9Index implementation**
 ...
 */
public class Lucene9Index implements QueryIndex {

    private static final Logger LOG = LoggerFactory.getLogger(Lucene9Index.class);

    private final Lucene9IndexTracker tracker;
    private final String indexPath;

    public Lucene9Index(Lucene9IndexTracker tracker, String indexPath) {
        this.tracker = tracker;
    ...
    public Cursor query(Filter filter, NodeState rootState) {
        try {
            ...
            // Return cursor
            return new Lucene9Cursor(docs, searcher, holder);
...
**Step 4: Create Lucene9Cursor**

Create: `src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9Cursor.java`
 ...
 */
public class Lucene9Cursor implements Cursor {

    private static final Logger LOG = LoggerFactory.getLogger(Lucene9Cursor.class);
    ...
    public Lucene9Cursor(TopDocs docs, IndexSearcher searcher, IndexSearcherHolder holder) {
        this.docs = docs;
    ...
    public IndexRow next() {
        ...
        try {
            ...
            return new Lucene9IndexRow(path, scoreDoc.score);
...
**Step 5: Create Lucene9IndexRow**

Create: `src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9IndexRow.java`
 ...
 */
public class Lucene9IndexRow implements IndexRow {

    private final String path;
    private final double score;

    public Lucene9IndexRow(String path, double score) {
        this.path = path;
        this.score = score;
    }
...
Add import in Lucene9IndexRow: `import org.apache.jackrabbit.oak.plugins.memory.PropertyValues;`
...
```bash
cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9
git add src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9Index.java \
        src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9Cursor.java \
        src/main/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9IndexRow.java \
        src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/Lucene9IndexTest.java
git commit -m "feat: add Lucene9Index with basic text search
...
**Files:**
- Modify: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IntegrationTest.java`
...
public void testEndToEndQueryWorkflow() throws Exception {
    ...
    Lucene9IndexEditorProvider editorProvider = new Lucene9IndexEditorProvider(tracker);
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=IntegrationTest#testEndToEndQueryWorkflow`
...
```bash
cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9
git add src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IntegrationTest.java
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn clean test`
...
- Lucene9QueryIndexProvider: Routes queries to indexes
- Lucene9Index: Executes basic text queries
- Lucene9Cursor/IndexRow: Result iteration
...
- Lucene9QueryIndexProvider for index routing
- Lucene9Index for query execution
...
2. Lucene9QueryIndexProvider - Implements QueryIndexProvider
3. Lucene9Index - Implements QueryIndex with basic text search
4. Lucene9Cursor/IndexRow - Result iteration
