...
1. **Lucene9QueryIndexProvider** (`QueryIndexProvider` implementation)
...
2. **Lucene9IndexPlanner** (created per query)
...
3. **Lucene9Index** (`AdvancedQueryIndex` implementation)
...
**Components:**
- `Lucene9QueryIndexProvider`
- `Lucene9IndexPlanner` (basic cost estimation only)
- `Lucene9Index` (text queries only)
...
- Enhanced `Lucene9IndexPlanner` (property index selection)
- Enhanced `Lucene9Index` (property queries)
...
- SortField handling in `Lucene9Index`
...
- `Lucene9IndexTracker` (track index updates)
- `Lucene9IndexDefinition` (index configuration)
