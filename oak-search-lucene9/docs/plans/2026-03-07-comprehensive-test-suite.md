...
**Files:**
- Create: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/directory/ChunkedIOEdgeCasesTest.java`
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=ChunkedIOEdgeCasesTest`
Expected: 5 tests pass

**Step 7: Commit**

```bash
git add src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/directory/ChunkedIOEdgeCasesTest.java
...
**Files:**
- Create: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/directory/ConcurrentFileAccessTest.java`
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=ConcurrentFileAccessTest`
Expected: 3 tests pass

**Step 5: Commit**

```bash
git add src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/directory/ConcurrentFileAccessTest.java
...
**Files:**
- Create: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/directory/ErrorHandlingTest.java`
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=ErrorHandlingTest`
Expected: 5 tests pass

**Step 7: Commit**

```bash
git add src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/directory/ErrorHandlingTest.java
...
**Files:**
- Create: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IndexingFunctionalTest.java`
...
public void testIndexEmptyNode() throws Exception {
    ...
    definition.setProperty("type", Lucene9IndexConstants.TYPE_LUCENE9);
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=IndexingFunctionalTest`
Expected: 7 tests pass

**Step 9: Commit**

```bash
git add src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IndexingFunctionalTest.java
...
**Files:**
- Create: `src/test/java/org/apache/jackrabbit/oak/plugins/index/lucene9/IntegrationTest.java`
...
public void testTrackerLifecycle() throws Exception {
    ...
    // Should find index1
    Lucene9IndexNode node1 = tracker.acquireIndexNode("/oak:index/index1");
    assertNotNull(node1);
...
Run: `cd /Users/bhabegger/claude/jackrabbit-oak/oak-search-lucene9 && mvn test -Dtest=IntegrationTest`
...
- **Tested with dedicated test files (8/12):**
  ...
  - Lucene9IndexEditor (via IndexingFunctionalTest, IntegrationTest)

- **Tested indirectly (2/12):**
  - BlobFactory - used in all I/O tests
  - Lucene9IndexNode - used in tracker tests
