 ...
 */
public class Lucene9IndexEditor implements Editor {
    private static final Logger LOG = LoggerFactory.getLogger(Lucene9IndexEditor.class);
    ...
    public Lucene9IndexEditor(@NotNull String path,
        ...
        LOG.debug("Created Lucene9IndexEditor for path: {}", path);
    }
