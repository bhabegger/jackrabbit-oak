...
/**
 * Lucene 9.x implementation of IndexWriter.
 * Wraps Lucene's IndexWriter for version-agnostic access.
 */
public final class Lucene9IndexWriter implements IndexWriter {
     ...
     */
    public Lucene9IndexWriter(Directory directory) throws IOException {
        if (directory == null) {
     ...
     * @throws IOException if the writer cannot be created
     */
    public Lucene9IndexWriter(Directory directory, IndexWriterConfig config) throws IOException {
    ...
    public void addDocument(Document doc) throws IOException {
        ...
        if (!(doc instanceof Lucene9Document)) {
            throw new IllegalArgumentException("Document must be Lucene9Document");
        }

        Lucene9Document lucene9Doc = (Lucene9Document) doc;
        delegate.addDocument(lucene9Doc.getLuceneDocument());
    }
    ...
    public void updateDocument(Term term, Document doc) throws IOException {
        ...
        Lucene9Document lucene9Doc = (Lucene9Document) doc;
        delegate.updateDocument(luceneTerm, lucene9Doc.getLuceneDocument());
    }
